      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="mb-6">
          <CardContent className="p-6">
            <p className="text-sm text-gray-600 mb-6">
              ...
              <br />
              <strong>PDPA Compliance:</strong> This policy complies with
            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="mb-4">
                  JRM E-commerce Sdn Bhd ("we," "our," or "us") respects your
                  privacy and is committed to protecting your personal data.
                  This privacy policy explains how we collect, use, disclose,
                  and safeguard your information when you visit our e-commerce
                  platform.
                </p>
                <p>
                  This policy complies with Malaysia's Personal Data Protection
                  Act 2010 (PDPA) and other applicable data protection laws.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside ml-4 mb-4 space-y-1">
                  <li>
                    <strong>Billplz:</strong> Payment processing (PCI DSS
                    compliant)
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Email services:</strong> Order confirmations and
                    communications
                  </li>
                  <li>
                    <strong>Cloud hosting:</strong> Secure data storage and
                    processing
                  </li>
                </ul>
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-sm">
                      Request access to your personal data and information about
                      how we process it.
                    </p>
                  </div>
                  <div className="p-4 border rounded-lg">
                  ...
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-sm">
                      Withdraw consent for marketing communications and optional
                      data processing.
                    </p>
                  </div>
                </div>
              ...
              <section>
                ...
                <ul className="list-disc list-inside ml-4 space-y-2">
                  <li>
                    <strong>Encryption:</strong> All data transmitted is
                  ...
                  <li>
                    <strong>Staff Training:</strong> Regular privacy and
              ...
              <section>
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  ...
                  <li>
                    Comply with Malaysian legal and tax requirements (7 years
                ...
                <p className="mt-4">
                  ...
                  anonymized in accordance with our data retention policy.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  ...
                  <li>
                    <strong>Performance Cookies:</strong> Help us improve
                    website performance
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Analytics Cookies:</strong> Understand how visitors
                    use our site
                  </li>
                </ul>
                <p className="mt-4">
                  You can manage cookie preferences through your browser
                  settings or our cookie management tool.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mb-4">
                  ...
                  Malaysia. If we need to transfer data internationally, we
              ...
              <section>
                ...
                <p className="mt-4 text-sm">
                  ...
                  Protection Department of Malaysia if you believe we have not
                  handled your personal data appropriately.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  you of material changes by email or through our website. The
                  "Last Updated" date at the top of this policy indicates when
                  the latest revision was made.
                </p>
              </section>
            </div>
          </CardContent>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600">
            This policy ensures compliance with Malaysian PDPA requirements and
