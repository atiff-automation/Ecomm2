      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="mb-6">
          <CardContent className="p-6">
            <p className="text-sm text-gray-600 mb-6">
              ...
              <strong>Compliance:</strong> Malaysian Consumer Protection Act 1999
            </p>
            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="mb-4">
                  At JRM E-commerce, we want you to be completely satisfied with your purchase. If you're not happy with your order, we offer a comprehensive return and refund policy that complies with Malaysian consumer protection laws.
                </p>
                <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                  ...
                  <p className="text-green-700 mt-2">
                    You have 14 days from the date of delivery to return eligible items for a full refund or exchange.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-sm mb-2"><strong>Return Window:</strong> 14 days from delivery</p>
                    <p className="text-sm"><strong>Processing Time:</strong> 3-5 business days after we receive your return</p>
                  </div>
                  <div className="p-4 border rounded-lg">
                    <h3 className="font-semibold mb-2 flex items-center">
                    ...
                    <p className="text-sm mb-2"><strong>Return Window:</strong> 7 days from delivery</p>
                    <p className="text-sm"><strong>Condition:</strong> Original packaging and accessories required</p>
                  </div>
                </div>
              </section>

              <section>
                <h2 className="text-xl font-semibold mb-4">3. Eligible Items for Return</h2>
                <div className="space-y-4">
                  <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                    <h3 className="font-semibold text-green-800 mb-2">✅ Items You Can Return:</h3>
                  ...
                  <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                    <h3 className="font-semibold text-red-800 mb-2">❌ Items You Cannot Return:</h3>
                    <ul className="list-disc list-inside text-red-700 space-y-1">
                      ...
                      <li>Items purchased with special promotions (case-by-case basis)</li>
                    </ul>
                  </div>
                </div>
              </section>
              ...
              <section>
                <h2 className="text-xl font-semibold mb-4">4. How to Return an Item</h2>
                <div className="space-y-4">
                  <div className="p-4 border-l-4 border-blue-500 bg-blue-50">
                    <h3 className="font-semibold mb-2">Step 1: Initiate Return Request</h3>
                    <ul className="text-sm space-y-1">
                      <li>• Log into your account and go to "My Orders"</li>
                      <li>• Click "Return Item" next to the eligible product</li>
                      <li>• Fill out the return reason and any additional details</li>
                      <li>• Submit your return request for approval</li>
                    </ul>
                  </div>

                  <div className="p-4 border-l-4 border-blue-500 bg-blue-50">
                    <h3 className="font-semibold mb-2">Step 2: Package Your Return</h3>
                    <ul className="text-sm space-y-1">
                  ...
                  <div className="p-4 border-l-4 border-blue-500 bg-blue-50">
                    ...
                    <ul className="text-sm space-y-1">
                      ...
                      <li>• Returns typically take 2-5 business days to reach us</li>
                    </ul>
                  </div>
                </div>
              </section>
                ...
                <div className="space-y-4">
                  <div className="p-4 border rounded-lg">
                    ...
                    <ul className="text-sm space-y-2">
                      ...
                      <li><strong>Approval:</strong> Email notification within 24 hours of inspection</li>
                  ...
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-sm mb-2">Refunds will be issued to your original payment method:</p>
                    <ul className="text-sm space-y-1">
                      <li>• <strong>Credit/Debit Card:</strong> 5-10 business days</li>
                      <li>• <strong>Online Banking:</strong> 3-5 business days</li>
              ...
              <section>
                <h2 className="text-xl font-semibold mb-4">6. Exchange Policy</h2>
                ...
                <p className="text-sm bg-yellow-50 p-3 rounded border border-yellow-200">
                  <strong>Note:</strong> Exchanges are subject to product availability. If the desired item is out of stock, we'll offer a full refund or store credit.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold mb-4">7. Return Shipping Costs</h2>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                  ...
                  <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <h3 className="font-semibold text-blue-800 mb-2">Customer Pays Shipping</h3>
              ...
              <section>
                ...
                <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <p className="text-blue-800 font-semibold">Quality Guarantee</p>
                  <p className="text-blue-700 text-sm mt-1">
                    We stand behind the quality of our products. If you're not satisfied with the quality, we'll make it right with a replacement or full refund.
                  </p>
                </div>
              </section>

              <section>
                <h2 className="text-xl font-semibold mb-4">9. Member Benefits</h2>
                <p className="mb-4">JRM E-commerce members enjoy additional return benefits:</p>
                <ul className="list-disc list-inside ml-4 space-y-1">
                  ...
                  <li>Option for instant store credit instead of waiting for refund</li>
              ...
              <section>
                ...
                <p>
                  We may update this Return & Refund Policy from time to time. Any changes will be posted on this page with the updated effective date. Continued use of our service after changes constitutes acceptance of the revised policy.
                </p>
              </section>
            </div>
          </CardContent>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600">
            This policy complies with Malaysian Consumer Protection Act 1999 and ensures fair treatment for all customers.
          </p>
        </div>
      </div>
    </div>
