      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="mb-6">
          <CardContent className="p-6">
            <p className="text-sm text-gray-600 mb-6">
              ...
              <strong>Compliance:</strong> GDPR, Malaysian PDPA, and international privacy standards
            </p>
            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="mb-4">
                  Cookies are small text files that are stored on your device (computer, smartphone, tablet) when you visit our website. They help our website function properly and provide you with a better browsing experience.
                </p>
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                  <p className="font-semibold text-blue-800 mb-2">Cookie Information Storage</p>
                  <p className="text-blue-700 text-sm">
                    Cookies may store information such as your preferences, login status, shopping cart contents, and website settings to enhance your experience on future visits.
                  </p>
                </div>
              </section>
                ...
                <div className="space-y-4">
                  <div className="p-4 border-l-4 border-green-500 bg-green-50">
                    ...
                    <ul className="text-green-600 text-sm space-y-1">
                      ...
                      <li>• <strong>CSRF Protection:</strong> Secure form submissions</li>
                    </ul>
                  </div>
                  ...
                  <div className="p-4 border-l-4 border-blue-500 bg-blue-50">
                    ...
                    <ul className="text-blue-600 text-sm space-y-1">
                      ...
                      <li>• <strong>Display Settings:</strong> Save your theme and layout preferences</li>
                      <li>• <strong>Location Data:</strong> Remember your delivery location</li>
                      <li>• <strong>Accessibility:</strong> Store accessibility settings</li>
                      <li>• <strong>Recently Viewed:</strong> Track products you've recently browsed</li>
                    </ul>
                  </div>
                  ...
                  <div className="p-4 border-l-4 border-yellow-500 bg-yellow-50">
                    ...
                    <ul className="text-yellow-600 text-sm space-y-1">
                      ...
                      <li>• <strong>Page Views:</strong> Monitor popular pages and products</li>
                      ...
                      <li>• <strong>Performance Monitoring:</strong> Optimize loading times</li>
                    </ul>
                  </div>
                  ...
                  <div className="p-4 border-l-4 border-purple-500 bg-purple-50">
                    ...
                    <p className="text-purple-700 text-sm mb-2">
                      These cookies help us show you relevant advertisements and measure campaign effectiveness.
                    </p>
                    <ul className="text-purple-600 text-sm space-y-1">
                      <li>• <strong>Facebook Pixel:</strong> Track conversions from Facebook ads</li>
                      <li>• <strong>Google Ads:</strong> Measure advertising campaign performance</li>
                      <li>• <strong>Retargeting:</strong> Show relevant ads on other websites</li>
                      <li>• <strong>Affiliate Tracking:</strong> Credit affiliate partners for referrals</li>
                      <li>• <strong>Email Marketing:</strong> Track email campaign engagement</li>
                    </ul>
                  </div>
                </div>
              </section>
              ...
              <section>
                <h2 className="text-xl font-semibold mb-4">3. Detailed Cookie Information</h2>
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-gray-300 text-sm">
                    ...
                    <tbody>
                      <tr>
                        <td className="border border-gray-300 p-3 font-mono">__session</td>
                        <td className="border border-gray-300 p-3">User session management</td>
                        <td className="border border-gray-300 p-3">Session</td>
                        <td className="border border-gray-300 p-3">Essential</td>
                      </tr>
                      <tr>
                        <td className="border border-gray-300 p-3 font-mono">cart_id</td>
                        <td className="border border-gray-300 p-3">Shopping cart persistence</td>
                        <td className="border border-gray-300 p-3">30 days</td>
                        <td className="border border-gray-300 p-3">Essential</td>
                      </tr>
                      <tr>
                        <td className="border border-gray-300 p-3 font-mono">auth_token</td>
                        <td className="border border-gray-300 p-3">Authentication state</td>
                        <td className="border border-gray-300 p-3">7 days</td>
                        <td className="border border-gray-300 p-3">Essential</td>
                      </tr>
                      <tr>
                        <td className="border border-gray-300 p-3 font-mono">theme_preference</td>
                        <td className="border border-gray-300 p-3">UI theme selection</td>
                        <td className="border border-gray-300 p-3">1 year</td>
                        <td className="border border-gray-300 p-3">Functional</td>
                      </tr>
                      <tr>
                        <td className="border border-gray-300 p-3 font-mono">language</td>
                      ...
                      <tr>
                        <td className="border border-gray-300 p-3 font-mono">_fbp</td>
                        <td className="border border-gray-300 p-3">Facebook Pixel tracking</td>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <h3 className="font-semibold text-blue-800 mb-2">Cookie Consent Banner</h3>
                    <p className="text-blue-700 text-sm">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="p-4 border rounded-lg">
                      <h3 className="font-semibold mb-2">Website Cookie Settings</h3>
                      <p className="text-sm mb-2">Change your cookie preferences at any time:</p>
                    ...
                    <div className="p-4 border rounded-lg">
                      ...
                      <p className="text-sm mb-2">Control cookies through your browser:</p>
                      <ul className="text-sm space-y-1">
              ...
              <section>
                <h2 className="text-xl font-semibold mb-4">5. Browser-Specific Instructions</h2>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 border rounded-lg">
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <h3 className="font-semibold text-yellow-800 mb-2">⚠️ Essential Cookies Disabled</h3>
                  ...
                  <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <h3 className="font-semibold text-blue-800 mb-2">ℹ️ Functional Cookies Disabled</h3>
                  ...
                  <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
                    <h3 className="font-semibold text-gray-800 mb-2">📊 Analytics/Marketing Cookies Disabled</h3>
              ...
              <section>
                <h2 className="text-xl font-semibold mb-4">7. Third-Party Cookies</h2>
                ...
                <div className="space-y-3">
                  <div className="p-3 border rounded">
                    ...
                    <p className="text-sm text-gray-600">Privacy Policy: <a href="https://policies.google.com/privacy" className="text-blue-600 hover:underline">Google Privacy Policy</a></p>
                  </div>
                  
                  <div className="p-3 border rounded">
                    <p><strong>Facebook Pixel:</strong> Advertising and conversion tracking</p>
                    <p className="text-sm text-gray-600">Privacy Policy: <a href="https://www.facebook.com/privacy/policy/" className="text-blue-600 hover:underline">Facebook Privacy Policy</a></p>
                  </div>
                  
                  <div className="p-3 border rounded">
                    <p><strong>Billplz:</strong> Payment processing</p>
                    <p className="text-sm text-gray-600">Privacy Policy: <a href="https://www.billplz.com/privacy" className="text-blue-600 hover:underline">Billplz Privacy Policy</a></p>
                  </div>

                  <div className="p-3 border rounded">
                    <p><strong>EasyParcel:</strong> Shipping and logistics</p>
                    <p className="text-sm text-gray-600">Privacy Policy: <a href="https://www.easyparcel.com/privacy" className="text-blue-600 hover:underline">EasyParcel Privacy Policy</a></p>
                  </div>
                </div>
              </section>

              <section>
                <h2 className="text-xl font-semibold mb-4">8. Mobile Apps and Cookies</h2>
                <p className="mb-4">
                  If you access our website through a mobile app or mobile browser, similar tracking technologies may be used. You can control these through your device settings:
                </p>
                <ul className="list-disc list-inside ml-4 space-y-1">
                  ...
                  <li><strong>Mobile Browser:</strong> Follow desktop browser instructions above</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="mb-4">
                  Cookie data is protected using industry-standard security measures:
                </p>
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li><strong>Encryption:</strong> Sensitive cookie data is encrypted</li>
                  <li><strong>Secure Transmission:</strong> Cookies sent over HTTPS connections</li>
                  <li><strong>HttpOnly Flags:</strong> Prevents access from JavaScript for security cookies</li>
                  <li><strong>SameSite Attributes:</strong> Protects against CSRF attacks</li>
                  <li><strong>Regular Cleanup:</strong> Expired cookies are automatically removed</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p>
                  Our website is not intended for children under 13. We do not knowingly collect cookie information from children under 13. Parents can control cookie settings on devices used by their children.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mb-4">
                  We may update this Cookie Policy from time to time to reflect changes in our practices or applicable laws. When we make significant changes:
                </p>
                <ul className="list-disc list-inside ml-4 space-y-1">
                  ...
                  <li>You'll have the opportunity to review and update your preferences</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="mb-4">For questions about our cookie policy or to exercise your privacy rights:</p>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="mt-2 text-sm">
                    <strong>Cookie Preferences:</strong> You can also manage cookies directly through our website's cookie settings.
                  </p>
                </div>
              </section>
            </div>
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-gray-600">
            This policy ensures transparency about our cookie usage and respects your privacy choices.
          </p>
        </div>
      </div>
    </div>
