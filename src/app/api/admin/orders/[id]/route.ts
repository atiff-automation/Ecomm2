...
export async function GET(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const transformedOrder = {
      ...
      memberDiscount: order.memberDiscount ? Number(order.memberDiscount) : null,
...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const transformedOrder = {
      ...
      memberDiscount: updatedOrder.memberDiscount ? Number(updatedOrder.memberDiscount) : null,
