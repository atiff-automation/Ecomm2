...
function DevicePreviewComponent({
  ...
  useEffect(() => {
    ...
    const handleWheel = (e: WheelEvent) => {
      ...
      // Snap to nearest granular zoom level (every 5%)
  ...
  return (
    <div
      ...
      className={cn(
        "flex-1 bg-gray-100",
        zoom <= 75 ? "overflow-y-auto overflow-x-hidden" : "overflow-auto"
      )}
    >
      ...
      <div
        ...
        style={{
          ...
          minWidth: zoom <= 75 ? '100%' : `${scaledWidth}px`,
          minHeight: '100%',
        }}
      >
        {/* Scaled viewport */}
