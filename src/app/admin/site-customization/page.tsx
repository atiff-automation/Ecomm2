          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 mb-4">
                ...
                Start with updating your hero section to showcase your products
                and value proposition, and configure your branding elements to
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Link href="/admin/site-customization/branding">
                  <Button variant="outline">
                    <Settings className="w-4 h-4 mr-2" />
                    Manage Branding
                  </Button>
