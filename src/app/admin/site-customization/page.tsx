...
export default function UnifiedSiteCustomization() {
  // ==================== STATE MANAGEMENT ====================
  ...
  if (isLoading) {
    return (
      <AdminPageLayout title="Site Customization" subtitle="Loading configuration...">
  ...
  return (
    <AdminPageLayout
      ...
      subtitle="Unified hero section and branding management"
      actions={pageActions}
    >
