              ...
              <div className="p-4 border border-blue-200 bg-blue-50 rounded-md">
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-blue-800">
                    <p>
                      Current threshold:{' '}
                      <strong>{formatPrice(config.membershipThreshold)}</strong>
                      <br />
                      Changing this will affect future membership qualifications
                      only.
                    </p>
                  </div>
                </div>
          ...
          <Card>
            ...
            <CardContent>
              <div>
                ...
                />
                <p className="text-sm text-gray-600 mt-1">
                  This text will be displayed to customers explaining membership
                  benefits
                </p>
              </div>
            </CardContent>
