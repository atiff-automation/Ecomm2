/**
 * Admin FAQ Category Edit Page
 * /admin/content/faq-categories/[id]/edit
 */
...
export default function AdminFAQCategoryEditPage({
  ...
  const form = useForm<FAQCategoryFormData>({
    resolver: zodResolver(faqCategoryUpdateSchema),
    defaultValues: {
      name: '',
      description: '',
      icon: 'Info',
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-4xl mx-auto">
      ...
      <div className="mb-6 md:mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-bold">Edit FAQ Category</h1>
