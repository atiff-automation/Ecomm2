...
import { Shield, Bell, Mail, MessageSquare, Globe, Download, Trash2 } from 'lucide-react';
...
export default function PrivacySettingsPage() {
  ...
  if (isLoading) {
    return <div className="flex justify-center py-8">Loading privacy settings...</div>;
  }
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(handleSavePreferences)} className="space-y-6">
        {/* Email Notifications */}
        <SettingsCard 
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4 ml-8">
              <SettingsSwitch
                ...
                onCheckedChange={(checked) => 
                  setValue('emailNotifications.orderConfirmation', checked, { shouldDirty: true })
                }
              />
              ...
              <SettingsSwitch
                ...
                onCheckedChange={(checked) => 
                  setValue('emailNotifications.orderStatusUpdate', checked, { shouldDirty: true })
                }
              />
              ...
              <SettingsSwitch
                ...
                onCheckedChange={(checked) => 
                  setValue('emailNotifications.shippingUpdate', checked, { shouldDirty: true })
                }
              />
              ...
              <SettingsSwitch
                ...
                onCheckedChange={(checked) => 
                  setValue('emailNotifications.deliveryUpdate', checked, { shouldDirty: true })
                }
              />
              ...
              <SettingsSwitch
                ...
                onCheckedChange={(checked) => 
                  setValue('emailNotifications.paymentConfirmation', checked, { shouldDirty: true })
                }
              />
            </div>
            ...
            <div className="space-y-4 ml-8">
              <SettingsSwitch
                ...
                onCheckedChange={(checked) => 
                  setValue('emailNotifications.promotionalOffers', checked, { shouldDirty: true })
                }
              />
              ...
              <SettingsSwitch
                ...
                onCheckedChange={(checked) => 
                  setValue('emailNotifications.memberBenefits', checked, { shouldDirty: true })
                }
              />
              ...
              <SettingsSwitch
                ...
                onCheckedChange={(checked) => 
                  setValue('emailNotifications.newsletter', checked, { shouldDirty: true })
                }
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4 ml-8">
              <SettingsSwitch
                ...
                onCheckedChange={(checked) => 
                  setValue('smsNotifications.orderConfirmation', checked, { shouldDirty: true })
                }
              />
              ...
              <SettingsSwitch
                ...
                onCheckedChange={(checked) => 
                  setValue('smsNotifications.shippingUpdate', checked, { shouldDirty: true })
                }
              />
              ...
              <SettingsSwitch
                ...
                onCheckedChange={(checked) => 
                  setValue('smsNotifications.deliveryUpdate', checked, { shouldDirty: true })
                }
              />
            </div>
            ...
            <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg mt-4">
              <p className="text-sm text-amber-800">
                <strong>Note:</strong> SMS notifications are sent to the phone number in your account. 
        ...
        >
          <div className="space-y-4">
            <SettingsSelect
              ...
              onValueChange={(value) => 
                setValue('language', value as 'en' | 'ms', { shouldDirty: true })
              }
            ...
            <SettingsSwitch
              ...
              onCheckedChange={(checked) => 
                setValue('marketingCommunications', checked, { shouldDirty: true })
              }
            />
          </div>
        </SettingsCard>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Download a copy of your personal data, including orders, addresses, and preferences
                  </p>
                </div>
              </div>
          ...
          <div className="p-4 bg-gray-50 rounded-lg">
            <div className="flex items-start space-x-3">
              ...
              <div className="space-y-2">
                <h4 className="font-medium text-gray-900">We Protect Your Privacy</h4>
                <p className="text-sm text-gray-600">
                  Your personal information is encrypted and securely stored. We never sell your data to third parties.
                </p>
                <p className="text-sm text-gray-600">
