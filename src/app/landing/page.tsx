/**
 * Public Landing Page Listing Page
 * /landing
 */
...
export default function LandingPage() {
  ...
  const fetchLandingPages = async () => {
    try {
      ...
      const response = await fetch(`/api/public/landing-pages?${params}`);
  ...
  const seoData = {
    title: page > 1 ? `Landing Pages - Page ${page}` : 'Landing Pages',
    description: 'Explore our collection of landing pages, guides, and resources',
    keywords: ['landing pages', 'guides', 'resources'],
  };
  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-base md:text-lg text-gray-600 mb-6 md:mb-8 px-2">
              Discover our collection of guides, resources, and special content
            </p>
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6 lg:px-16">
          {loading ? (
            <div className="text-center py-12">Loading landing pages...</div>
          ) : landingPages.length === 0 ? (
            <div className="text-center py-12 text-gray-500">
              <p className="text-lg">No landing pages found.</p>
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
                {landingPages.map((landingPage) => (
                  <Link key={landingPage.id} href={`/landing/${landingPage.slug}`}>
                      ...
                      <CardContent className="p-4 md:p-6">
                        ...
                        <div className="flex flex-wrap items-center gap-3 md:gap-4 text-xs md:text-sm text-gray-500 pt-4 border-t">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <span>{landingPage.readingTimeMin} min read</span>
                          </div>
                          <div className="flex items-center gap-1">
                            <Eye className="w-3 h-3 md:w-4 md:h-4" />
                            <span>{landingPage.viewCount} views</span>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
      ...
      <section className="py-12 md:py-16 bg-gradient-to-br from-green-50 to-emerald-50">
        <div className="container mx-auto px-4 md:px-6 lg:px-16 text-center">
          ...
          <p className="text-sm md:text-base text-gray-600 mb-6 max-w-2xl mx-auto">
            Explore our products and discover what we have to offer
          </p>
          <Link href="/products">
