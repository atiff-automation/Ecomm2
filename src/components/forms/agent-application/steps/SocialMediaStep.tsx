          ...
          <CardTitle className="flex items-center space-x-2">
            ...
            {instagramLevel && (
              <Badge className={getLevelColor(instagramLevel)}>
                ...
                <span className="ml-1">
                  {SOCIAL_MEDIA_LEVELS[instagramLevel]}
                </span>
              </Badge>
            )}
          </CardTitle>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <Label htmlFor="instagramLevel" className="text-sm font-medium">
                {FIELD_LABELS.instagramLevel}{' '}
                <span className="text-red-500">*</span>
              </Label>
              <Select
                value={instagramLevel || ''}
                onValueChange={value =>
                  setValue('instagramLevel', value as SocialMediaLevel)
                }
              >
                <SelectTrigger
                  className={errors.instagramLevel ? 'border-red-300' : ''}
                >
          ...
          <CardTitle className="flex items-center space-x-2">
            ...
            {facebookLevel && (
              <Badge className={getLevelColor(facebookLevel)}>
                ...
                <span className="ml-1">
                  {SOCIAL_MEDIA_LEVELS[facebookLevel]}
                </span>
              </Badge>
            )}
          </CardTitle>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <Label htmlFor="facebookLevel" className="text-sm font-medium">
                {FIELD_LABELS.facebookLevel}{' '}
                <span className="text-red-500">*</span>
              </Label>
              <Select
                value={facebookLevel || ''}
                onValueChange={value =>
                  setValue('facebookLevel', value as SocialMediaLevel)
                }
              >
                <SelectTrigger
                  className={errors.facebookLevel ? 'border-red-300' : ''}
                >
                  <SelectValue placeholder="Pilih tahap kemahiran" />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <Label htmlFor="tiktokLevel" className="text-sm font-medium">
                {FIELD_LABELS.tiktokLevel}{' '}
                <span className="text-red-500">*</span>
              </Label>
              <Select
                value={tiktokLevel || ''}
                onValueChange={value =>
                  setValue('tiktokLevel', value as SocialMediaLevel)
                }
              >
                <SelectTrigger
                  className={errors.tiktokLevel ? 'border-red-300' : ''}
                >
                  <SelectValue placeholder="Pilih tahap kemahiran" />
                </SelectTrigger>
                <SelectContent>
        ...
        <CardContent className="p-4">
          ...
          <div className="space-y-2 text-sm text-blue-800">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span>
                Pakar dalam strategi konten dan pertumbuhan engagement
              </span>
            </div>
          </div>
        </CardContent>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="text-sm text-amber-800">
            <p className="font-medium mb-1">
              Mengapa Maklumat Media Sosial Penting?
            </p>
            <p>
              Kemahiran media sosial adalah aset penting untuk ejen JRM.
              Platform ini membantu kami memahami kekuatan anda dalam pemasaran
              digital dan memberikan sokongan yang sesuai untuk memaksimumkan
              potensi jualan anda.
            </p>
          </div>
        </div>
