...
export const DEMO_CONFIG = {
  ...
  messages: {
    checkout:
      "We're putting the finishing touches on our checkout system! Full shopping features will be available very soon. Thank you for your patience!",
    signup:
      'Account registration is coming soon! You can browse our products and experience the website without creating an account. Full features will be available shortly!',
  },
...
export type DemoAction =
  | (typeof DEMO_CONFIG.allowedDemoActions)[number]
  | (typeof DEMO_CONFIG.blockedActions)[number];

// Helper functions
export const isDemoEnabled = () => DEMO_CONFIG.enabled;
export const getDemoMessage = (type: DemoMessageType) =>
  DEMO_CONFIG.messages[type];
