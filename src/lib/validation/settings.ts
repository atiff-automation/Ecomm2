...
export const MalaysianStates = [
  'JOH', 'KDH', 'KTN', 'MLK', 'NSN', 'PHG', 'PRK', 'PLS', 'PNG', 
  'KUL', 'TRG', 'SEL', 'SBH', 'SWK', 'LBN'
] as const;
...
export const personalInfoSchema = z.object({
  ...
  phone: z.string()
    .regex(MALAYSIAN_PHONE_REGEX, 'Invalid Malaysian mobile phone number (e.g., 012-3456789)')
    .optional()
    .or(z.literal('')),
