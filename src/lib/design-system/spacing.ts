...
export const componentSpacing = {
  ...
  productCard: () =>
    cn(semanticSpacing.card.padding.md, semanticSpacing.card.content, 'group'),

  // Section header spacing
  sectionHeader: () => cn('mb-8 lg:mb-12', semanticSpacing.component.md),

  // Form field spacing
  formField: () => cn(semanticSpacing.form.field, 'mb-4'),

  // Button group spacing
  buttonGroup: () => cn('flex', semanticSpacing.button.gap, 'items-center'),

  // Navigation spacing
  navItem: () => cn(semanticSpacing.button.padding.sm, 'rounded-md'),
};
