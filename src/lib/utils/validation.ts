...
export const validationSchemas = {
  ...
  malaysianPhone: {
    required: true,
    custom: (value: string) =>
      isValidMalaysianPhone(value) ? null : 'Invalid Malaysian phone number',
  },

  postalCode: {
    required: true,
    custom: (value: string) =>
      isValidMalaysianPostalCode(value) ? null : 'Invalid postal code',
  },

  orderNumber: {
    required: true,
    custom: (value: string) =>
      isValidOrderNumber(value) ? null : 'Invalid order number format',
  },

  productSku: {
    required: true,
    custom: (value: string) =>
      isValidSku(value) ? null : 'Invalid SKU format',
  },
} as const;
