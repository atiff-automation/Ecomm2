...
export type EasyParcelBooleanOption =
  (typeof EASYPARCEL_BOOLEAN_OPTIONS)[number];
...
export function validateEasyParcelValues(values: {
  ...
  if (
    values.category &&
    !EASYPARCEL_CATEGORIES.includes(values.category as EasyParcelCategory)
  ) {
  ...
  if (
    values.courier &&
    !EASYPARCEL_COURIERS.includes(values.courier as EasyParcelCourier)
  ) {
  ...
  if (
    values.trackingSms &&
    !EASYPARCEL_BOOLEAN_OPTIONS.includes(
      values.trackingSms as EasyParcelBooleanOption
    )
  ) {
  ...
  if (
    values.dropOffAtBranch &&
    !EASYPARCEL_BOOLEAN_OPTIONS.includes(
      values.dropOffAtBranch as EasyParcelBooleanOption
    )
  ) {
  ...
  if (
    values.trackingWhatsapp &&
    !EASYPARCEL_BOOLEAN_OPTIONS.includes(
      values.trackingWhatsapp as EasyParcelBooleanOption
    )
  ) {
