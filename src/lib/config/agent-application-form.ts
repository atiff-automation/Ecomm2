...
export const FORM_STEPS = [
  {
    ...
    fields: ['acceptTerms'],
    description:
      'Sila baca dan setuju dengan syarat-syarat pengambilan sebelum meneruskan permohonan.',
  },
  {
    id: 'basic-info',
    title: 'Maklumat Asas',
  ...
  },
  {
    ...
    description:
      'Kongsikan pengalaman dan motivasi anda untuk menyertai program ini.',
  },
  {
    id: 'review',
...
export const FIELD_LABELS = {
  ...
  businessLocation:
    'Nyatakan pertokolan/lokasi perniagaan anda (Isi NA jika anda tidak berniaga)',
  hasTeamLeadExp:
    'Sekiranya tiada berniaga, nyatakan pengalaman sama ada (Isi NA jika tiada menakdikan seokililing ini)',
  ...
  socialMediaExpertise:
    'Sila pilih tahap kemahiran anda dalam menggunakan media sosial',

  // Step 4: Additional Info
  hasJrmExp: 'Adakah anda ahli JRM?',
  jrmProducts:
    'Keahlian dibawah pengedar/Stokis/HQ (Nyatakan nama. Tulis NA jika tiada)',
  reasonToJoin:
    'Nyatakan produk JRM yang pernah anda gunakan (Tulis NA jika tiada)',
  expectations: 'Apakah sebab utama anda ingin menjadi pengedar JRM?',

  // Step 5: Review
  finalAgreement:
    'Saya mengaku maklumat yang diberikan adalah benar. Pihak JRM berhak menggunakan permohonan saya sekiranya maklumat yang diberikan adalah tidak benar.',
} as const;
...
export const TERMS_CONTENT = {
  ...
  terms: [
    ...
    },
    {
      number: 2,
      title:
        'Pengedar boleh buat jualan online, *tetapi tidak dibenarkan di platform Shopee, Lazada dan seumpama*.',
    },
    {
      number: 3,
  ...
  footer:
    'Sekiranya anda setuju dan berminat isi maklumat di borang ini dengan lengkap.',
} as const;
