...
export const DEFAULT_TEMPLATE_CONFIGS: Record<ReceiptTemplateType, ReceiptTemplateContent> = {
  THERMAL_RECEIPT: {
    ...
    sections: {
      header: { enabled: true, showLogo: false, showCompanyInfo: true, alignment: 'center' },
      customer: { enabled: true, showMemberBadge: true, showBillingAddress: false },
      items: { enabled: true, showSKU: true, showDescription: false },
      totals: { enabled: true, showTaxBreakdown: true, showDiscount: true },
      footer: { enabled: true, message: 'Thank you for your business!', showGeneratedDate: true }
    }
  },
  BUSINESS_INVOICE: {
    ...
    sections: {
      header: { enabled: true, showLogo: true, showCompanyInfo: true, alignment: 'left' },
      customer: { enabled: true, showMemberBadge: true, showBillingAddress: true },
  ...
  MINIMAL_RECEIPT: {
    ...
    sections: {
      header: { enabled: true, showLogo: true, showCompanyInfo: true, alignment: 'center' },
      customer: { enabled: true, showMemberBadge: false, showBillingAddress: false },
  ...
  DETAILED_INVOICE: {
    ...
    sections: {
      ...
      items: { enabled: true, showSKU: true, showDescription: true },
      totals: { enabled: true, showTaxBreakdown: true, showDiscount: true },
      footer: { enabled: true, message: 'Please retain this invoice for your records', showGeneratedDate: true }
    }
  }
};